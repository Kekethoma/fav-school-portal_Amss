...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300 selection:bg-[#60a5fa] selection:text-black font-sans dark:bg-black dark:text-white">
      {/* Dynamic Background Overlay */}
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none opacity-50 dark:opacity-100">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[#1e40af]/10 dark:bg-[#1e40af]/20 blur-[120px] rounded-full" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-[#60a5fa]/5 dark:bg-[#60a5fa]/10 blur-[120px] rounded-full" />
      </div>
        ...
        <nav className="border-b border-border bg-background/50 dark:border-white/10 dark:bg-black/50 backdrop-blur-xl sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className="bg-gradient-to-br from-[#1e40af] to-[#1e3a8a] p-2 rounded-lg">
                <GraduationCap className="h-8 w-8 text-[#60a5fa]" />
              </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                href="/login"
                className="px-6 py-2.5 bg-[#60a5fa] text-black font-bold rounded-full hover:scale-105 transition-transform"
              >
                Portal Login
              </Link>
            </div>
        ...
        <header className="relative py-24 px-6 overflow-hidden">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 animate-fadeIn">
              <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-[#1e40af]/20 border border-[#1e40af]/30 text-[#60a5fa] text-sm font-bold uppercase tracking-widest">
              ...
              <h1 className="text-6xl md:text-8xl font-black leading-[0.9] tracking-tighter">
                SHAPING <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#60a5fa] to-[#93c5fd]">FUTURES</span> THROUGH KNOWLEDGE.
              </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                {BENEFITS.map((benefit, i) => (
                  <div key={i} className="flex items-center space-x-3 text-gray-400 group">
                    <CheckCircle2 className="h-5 w-5 text-[#1e40af] group-hover:text-[#60a5fa] transition-colors" />
            ...
            <div className="relative">
              <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-12 relative overflow-hidden group min-h-[300px] flex flex-col justify-center">
                <Quote className="absolute top-8 left-8 h-12 w-12 text-[#1e40af] opacity-20" />
                <div className="relative z-10 space-y-6">
                  <p className="text-3xl font-serif italic text-white/90 leading-snug animate-fadeIn" key={quoteIndex}>
                    &quot;{QUOTES[quoteIndex].text}&quot;
                  </p>
                  <p className="text-[#60a5fa] font-bold tracking-widest uppercase text-sm">
                    — {QUOTES[quoteIndex].author}
                  </p>
                </div>
                <div className="absolute bottom-0 right-0 w-32 h-32 bg-[#60a5fa]/5 blur-2xl rounded-full" />
              </div>
            </div>
          </div>
        </header>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Link href="/login" className="group">
                <div className="h-full p-8 rounded-3xl bg-gradient-to-br from-[#1e40af] to-[#1e3a8a] border border-[#1e40af]/50 group-hover:scale-105 group-hover:-rotate-1 transition-all duration-500 shadow-2xl">
                  <Shield className="h-12 w-12 text-[#60a5fa] mb-6" />
                  ...
                  <div className="flex items-center text-[#60a5fa] font-bold uppercase tracking-widest text-sm">
              ...
              <Link href="/login" className="group">
                <div className="h-full p-8 rounded-3xl bg-neutral-900 border border-white/10 group-hover:scale-105 group-hover:rotate-1 transition-all duration-500 shadow-2xl relative overflow-hidden">
                  ...
                  <Users className="h-12 w-12 text-[#60a5fa] mb-6" />
              ...
              {/* Student Card */}
              <Link href="/login" className="group">
                <div className="h-full p-8 rounded-3xl bg-neutral-900 border border-white/10 group-hover:scale-105 transition-all duration-500 shadow-2xl border-b-4 border-b-[#1e40af]">
                  <BookOpen className="h-12 w-12 text-[#60a5fa] mb-6" />
        ...
        <footer className="py-12 px-6 border-t border-white/10 bg-black">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center space-x-2">
              <GraduationCap className="h-6 w-6 text-[#60a5fa]" />
