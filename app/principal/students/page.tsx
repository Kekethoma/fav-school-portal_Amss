            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {filteredStudents.map((student) => (
                        <Card key={student.id} className="border-white/10 bg-black/40 backdrop-blur-sm hover:border-[#60a5fa]/50 transition-all group">
                            <CardContent className="p-6">
                                <div className="flex items-start justify-between mb-4">
                                    <div className="w-12 h-12 bg-[#1e40af]/20 rounded-full flex items-center justify-center group-hover:bg-[#1e40af]/40 transition-colors">
                                ...
                                <p className="text-[#60a5fa] text-sm font-medium mb-4">{student.studentId}</p>
